-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\lab3_step9\dataplane_ip_rdfifo_last.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dataplane_ip_rdfifo_last
-- Source Path: dataplane_ip/dataplane_ip_axi4/dataplane_ip_axi4_module/dataplane_ip_rdfifo_last
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY dataplane_ip_rdfifo_last IS
...
END dataplane_ip_rdfifo_last;


ARCHITECTURE rtl OF dataplane_ip_rdfifo_last IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT dataplane_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : dataplane_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.dataplane_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_dataplane_ip_rdfifo_last_classic_ram_singlebit : dataplane_ip_SimpleDualPortRAM_singlebit
