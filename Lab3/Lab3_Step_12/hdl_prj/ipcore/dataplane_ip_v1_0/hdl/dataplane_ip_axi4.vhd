-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\lab3_step9\dataplane_ip_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dataplane_ip_axi4
-- Source Path: dataplane_ip/dataplane_ip_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END dataplane_ip_axi4;


ARCHITECTURE rtl OF dataplane_ip_axi4 IS

  -- Component Declarations
  COMPONENT dataplane_ip_addr_decoder
  ...
  COMPONENT dataplane_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : dataplane_ip_addr_decoder
    USE ENTITY work.dataplane_ip_addr_decoder(rtl);

  FOR ALL : dataplane_ip_axi4_module
    USE ENTITY work.dataplane_ip_axi4_module(rtl);
...
BEGIN
  u_dataplane_ip_addr_decoder_inst : dataplane_ip_addr_decoder
  ...
  u_dataplane_ip_axi4_module_inst : dataplane_ip_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
