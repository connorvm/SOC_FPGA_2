-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\lab3_step9\dataplane_ip_src_LED_persistence_control2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dataplane_ip_src_LED_persistence_control2
-- Source Path: lab3_step9/dataplane/Avalon Data Processing/Left Channel Processing/Signal Energy Monitor/LED_Driver/LED_persistence_control2
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY dataplane_ip_src_LED_persistence_control2 IS
...
END dataplane_ip_src_LED_persistence_control2;


ARCHITECTURE rtl OF dataplane_ip_src_LED_persistence_control2 IS
