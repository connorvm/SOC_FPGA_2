...
set_module_property NAME dataplane_ip
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "HDL Coder Generated IP"
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME dataplane_ip
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL dataplane_ip
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file dataplane_ip_src_dataplane_pkg.vhd VHDL PATH hdl/dataplane_ip_src_dataplane_pkg.vhd 
add_fileset_file dataplane_ip_src_Chart.vhd VHDL PATH hdl/dataplane_ip_src_Chart.vhd 
add_fileset_file dataplane_ip_src_LED_persistence_control.vhd VHDL PATH hdl/dataplane_ip_src_LED_persistence_control.vhd 
add_fileset_file dataplane_ip_src_LED_persistence_control1.vhd VHDL PATH hdl/dataplane_ip_src_LED_persistence_control1.vhd 
add_fileset_file dataplane_ip_src_LED_persistence_control2.vhd VHDL PATH hdl/dataplane_ip_src_LED_persistence_control2.vhd 
add_fileset_file dataplane_ip_src_LED_persistence_control3.vhd VHDL PATH hdl/dataplane_ip_src_LED_persistence_control3.vhd 
add_fileset_file dataplane_ip_src_LED_persistence_control4.vhd VHDL PATH hdl/dataplane_ip_src_LED_persistence_control4.vhd 
add_fileset_file dataplane_ip_src_LED_persistence_control5.vhd VHDL PATH hdl/dataplane_ip_src_LED_persistence_control5.vhd 
add_fileset_file dataplane_ip_src_LED_persistence_control6.vhd VHDL PATH hdl/dataplane_ip_src_LED_persistence_control6.vhd 
add_fileset_file dataplane_ip_src_LED_persistence_control7.vhd VHDL PATH hdl/dataplane_ip_src_LED_persistence_control7.vhd 
add_fileset_file dataplane_ip_src_LED_Driver.vhd VHDL PATH hdl/dataplane_ip_src_LED_Driver.vhd 
add_fileset_file dataplane_ip_src_Min.vhd VHDL PATH hdl/dataplane_ip_src_Min.vhd 
add_fileset_file dataplane_ip_src_MinMax.vhd VHDL PATH hdl/dataplane_ip_src_MinMax.vhd 
add_fileset_file dataplane_ip_src_Normalize_Signal.vhd VHDL PATH hdl/dataplane_ip_src_Normalize_Signal.vhd 
add_fileset_file dataplane_ip_src_Signal_Energy_Monitor.vhd VHDL PATH hdl/dataplane_ip_src_Signal_Energy_Monitor.vhd 
add_fileset_file dataplane_ip_src_Sound_Effects.vhd VHDL PATH hdl/dataplane_ip_src_Sound_Effects.vhd 
add_fileset_file dataplane_ip_src_Left_Channel_Processing.vhd VHDL PATH hdl/dataplane_ip_src_Left_Channel_Processing.vhd 
add_fileset_file dataplane_ip_src_Sound_Effects_block.vhd VHDL PATH hdl/dataplane_ip_src_Sound_Effects_block.vhd 
add_fileset_file dataplane_ip_src_Right_Channel_Processing.vhd VHDL PATH hdl/dataplane_ip_src_Right_Channel_Processing.vhd 
add_fileset_file dataplane_ip_src_Avalon_Data_Processing.vhd VHDL PATH hdl/dataplane_ip_src_Avalon_Data_Processing.vhd 
add_fileset_file dataplane_ip_src_dataplane.vhd VHDL PATH hdl/dataplane_ip_src_dataplane.vhd 
add_fileset_file dataplane_ip_reset_sync.vhd VHDL PATH hdl/dataplane_ip_reset_sync.vhd 
add_fileset_file dataplane_ip_dut.vhd VHDL PATH hdl/dataplane_ip_dut.vhd 
add_fileset_file dataplane_ip_addr_decoder.vhd VHDL PATH hdl/dataplane_ip_addr_decoder.vhd 
add_fileset_file dataplane_ip_SimpleDualPortRAM_generic.vhd VHDL PATH hdl/dataplane_ip_SimpleDualPortRAM_generic.vhd 
add_fileset_file dataplane_ip_rdfifo_data.vhd VHDL PATH hdl/dataplane_ip_rdfifo_data.vhd 
add_fileset_file dataplane_ip_SimpleDualPortRAM_singlebit.vhd VHDL PATH hdl/dataplane_ip_SimpleDualPortRAM_singlebit.vhd 
add_fileset_file dataplane_ip_rdfifo_last.vhd VHDL PATH hdl/dataplane_ip_rdfifo_last.vhd 
add_fileset_file dataplane_ip_rdfifo_rid.vhd VHDL PATH hdl/dataplane_ip_rdfifo_rid.vhd 
add_fileset_file dataplane_ip_axi4_module.vhd VHDL PATH hdl/dataplane_ip_axi4_module.vhd 
add_fileset_file dataplane_ip_axi4.vhd VHDL PATH hdl/dataplane_ip_axi4.vhd 
add_fileset_file dataplane_ip.vhd VHDL PATH hdl/dataplane_ip.vhd TOP_LEVEL_FILE
