-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\lab3_step9\dataplane_ip.vhd
...
ARCHITECTURE rtl OF dataplane_ip IS

  -- Component Declarations
  COMPONENT dataplane_ip_reset_sync
  ...
  FOR ALL : dataplane_ip_reset_sync
    USE ENTITY work.dataplane_ip_reset_sync(rtl);

  FOR ALL : dataplane_ip_axi4
    USE ENTITY work.dataplane_ip_axi4(rtl);

  FOR ALL : dataplane_ip_dut
    USE ENTITY work.dataplane_ip_dut(rtl);
...
BEGIN
  u_dataplane_ip_reset_sync_inst : dataplane_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_dataplane_ip_axi4_inst : dataplane_ip_axi4
  ...
  u_dataplane_ip_dut_inst : dataplane_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  ip_timestamp <= to_unsigned(2004221535, 32);
