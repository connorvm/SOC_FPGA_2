-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\lab3_step9\dataplane_ip_src_Signal_Energy_Monitor.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dataplane_ip_src_Signal_Energy_Monitor
...
ENTITY dataplane_ip_src_Signal_Energy_Monitor IS
...
END dataplane_ip_src_Signal_Energy_Monitor;


ARCHITECTURE rtl OF dataplane_ip_src_Signal_Energy_Monitor IS

  -- Component Declarations
  COMPONENT dataplane_ip_src_Normalize_Signal
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Signal_Sink                     :   IN    std_logic_vector(31 DOWNTO 0);  -- sfix32_En28
  ...
  COMPONENT dataplane_ip_src_LED_Driver
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : dataplane_ip_src_Normalize_Signal
    USE ENTITY work.dataplane_ip_src_Normalize_Signal(rtl);

  FOR ALL : dataplane_ip_src_LED_Driver
    USE ENTITY work.dataplane_ip_src_LED_Driver(rtl);
...
BEGIN
  u_Normalize_Signal : dataplane_ip_src_Normalize_Signal
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_LED_Driver : dataplane_ip_src_LED_Driver
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
