-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\lab3_step9\dataplane_ip_rdfifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dataplane_ip_rdfifo_data
-- Source Path: dataplane_ip/dataplane_ip_axi4/dataplane_ip_axi4_module/dataplane_ip_rdfifo_data
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY dataplane_ip_rdfifo_data IS
...
END dataplane_ip_rdfifo_data;


ARCHITECTURE rtl OF dataplane_ip_rdfifo_data IS

  ATTRIBUTE multstyle : string;

  -- Component Declarations
  COMPONENT dataplane_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : dataplane_ip_SimpleDualPortRAM_generic
    USE ENTITY work.dataplane_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_dataplane_ip_rdfifo_data_classic_ram_generic : dataplane_ip_SimpleDualPortRAM_generic
