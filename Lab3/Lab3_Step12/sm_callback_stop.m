...
% Dont' run this when the model is converted to VHDL since we dont't 
...
if mp.fastsim_flag ~= 3  % Don't run when in HDL Coder Mode
    ...
    % Put th eoutput into the mp data struct
    % Note: The "To Wrokspace" block won't accept structs
