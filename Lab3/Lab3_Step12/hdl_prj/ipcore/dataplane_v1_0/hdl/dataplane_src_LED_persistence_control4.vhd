-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\lab3_step9\dataplane_src_LED_persistence_control4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dataplane_src_LED_persistence_control4
-- Source Path: lab3_step9/dataplane/Avalon Data Processing/Left Channel Processing/Signal Energy Monitor/LED_Driver/LED_persistence_control4
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY dataplane_src_LED_persistence_control4 IS
...
END dataplane_src_LED_persistence_control4;


ARCHITECTURE rtl OF dataplane_src_LED_persistence_control4 IS
