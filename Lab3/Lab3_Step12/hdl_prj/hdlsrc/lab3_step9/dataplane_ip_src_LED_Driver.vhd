-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\lab3_step9\dataplane_ip_src_LED_Driver.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dataplane_ip_src_LED_Driver
...
ENTITY dataplane_ip_src_LED_Driver IS
...
END dataplane_ip_src_LED_Driver;


ARCHITECTURE rtl OF dataplane_ip_src_LED_Driver IS

  -- Component Declarations
  COMPONENT dataplane_ip_src_LED_persistence_control
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT dataplane_ip_src_LED_persistence_control1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          LED_trigger                     :   IN    std_logic;
  ...
  COMPONENT dataplane_ip_src_LED_persistence_control2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          LED_trigger                     :   IN    std_logic;
  ...
  COMPONENT dataplane_ip_src_LED_persistence_control3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          LED_trigger                     :   IN    std_logic;
  ...
  COMPONENT dataplane_ip_src_LED_persistence_control4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          LED_trigger                     :   IN    std_logic;
  ...
  COMPONENT dataplane_ip_src_LED_persistence_control5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          LED_trigger                     :   IN    std_logic;
  ...
  COMPONENT dataplane_ip_src_LED_persistence_control6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          LED_trigger                     :   IN    std_logic;
  ...
  COMPONENT dataplane_ip_src_LED_persistence_control7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          LED_trigger                     :   IN    std_logic;
  ...
  FOR ALL : dataplane_ip_src_LED_persistence_control
    USE ENTITY work.dataplane_ip_src_LED_persistence_control(rtl);

  FOR ALL : dataplane_ip_src_LED_persistence_control1
    USE ENTITY work.dataplane_ip_src_LED_persistence_control1(rtl);

  FOR ALL : dataplane_ip_src_LED_persistence_control2
    USE ENTITY work.dataplane_ip_src_LED_persistence_control2(rtl);

  FOR ALL : dataplane_ip_src_LED_persistence_control3
    USE ENTITY work.dataplane_ip_src_LED_persistence_control3(rtl);

  FOR ALL : dataplane_ip_src_LED_persistence_control4
    USE ENTITY work.dataplane_ip_src_LED_persistence_control4(rtl);

  FOR ALL : dataplane_ip_src_LED_persistence_control5
    USE ENTITY work.dataplane_ip_src_LED_persistence_control5(rtl);

  FOR ALL : dataplane_ip_src_LED_persistence_control6
    USE ENTITY work.dataplane_ip_src_LED_persistence_control6(rtl);

  FOR ALL : dataplane_ip_src_LED_persistence_control7
    USE ENTITY work.dataplane_ip_src_LED_persistence_control7(rtl);
...
BEGIN
  u_LED_persistence_control : dataplane_ip_src_LED_persistence_control
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_LED_persistence_control1 : dataplane_ip_src_LED_persistence_control1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_LED_persistence_control2 : dataplane_ip_src_LED_persistence_control2
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_LED_persistence_control3 : dataplane_ip_src_LED_persistence_control3
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_LED_persistence_control4 : dataplane_ip_src_LED_persistence_control4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_LED_persistence_control5 : dataplane_ip_src_LED_persistence_control5
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_LED_persistence_control6 : dataplane_ip_src_LED_persistence_control6
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_LED_persistence_control7 : dataplane_ip_src_LED_persistence_control7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
