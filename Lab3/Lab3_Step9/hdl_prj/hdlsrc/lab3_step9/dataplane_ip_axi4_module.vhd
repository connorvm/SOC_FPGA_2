-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\lab3_step9\dataplane_ip_axi4_module.vhd
-- Created: 2020-04-22 15:35:36
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: dataplane_ip_axi4_module
-- Source Path: dataplane_ip/dataplane_ip_axi4/dataplane_ip_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY dataplane_ip_axi4_module IS
...
END dataplane_ip_axi4_module;


ARCHITECTURE rtl OF dataplane_ip_axi4_module IS

  -- Component Declarations
  COMPONENT dataplane_ip_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT dataplane_ip_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT dataplane_ip_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : dataplane_ip_rdfifo_data
    USE ENTITY work.dataplane_ip_rdfifo_data(rtl);

  FOR ALL : dataplane_ip_rdfifo_rid
    USE ENTITY work.dataplane_ip_rdfifo_rid(rtl);

  FOR ALL : dataplane_ip_rdfifo_last
    USE ENTITY work.dataplane_ip_rdfifo_last(rtl);
...
BEGIN
  u_dataplane_ip_rdfifo_data_inst : dataplane_ip_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_dataplane_ip_rdfifo_rid_inst : dataplane_ip_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_dataplane_ip_rdfifo_last_inst : dataplane_ip_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
